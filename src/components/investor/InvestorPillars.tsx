        ...
        {pillars.map((p, index) => (
          <Link key={p.id} href={p.route}>
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative overflow-hidden rounded-2xl border border-[#D4AF37]/40 bg-[#00152c] shadow-[0_0_30px_rgba(0,0,0,0.6)] hover:shadow-[0_0_40px_rgba(212,175,55,0.3)] transition-shadow duration-500"
            >
              {/* Video background */}
              <video
                src={p.video}
              ...
              {/* Gradient overlay */}
              <div className="absolute inset-0 bg-gradient-to-b from-[#001F3F]/40 via-[#001F3F]/70 to-[#00152c]" />

              {/* Animated logo with subtle glow */}
              <div className="absolute top-4 left-4 h-10 w-10 overflow-hidden rounded-md border border-[#D4AF37]/70 bg-black/50 shadow-[0_0_15px_rgba(212,175,55,0.3)] group-hover:shadow-[0_0_25px_rgba(212,175,55,0.5)] transition-shadow duration-500">
                <video
              ...
              <div className="relative z-10 flex flex-col justify-end h-64 p-6">
                <h3 className="text-lg font-bold text-[#F4E5B1] mb-1 group-hover:text-white transition-colors duration-300">
                  {p.title}
                </h3>
                <p className="text-sm text-[#D4AF37]/90 mb-3">
                  {p.subtitle}
                </p>
                <p className="inline-block text-[11px] font-semibold uppercase tracking-[0.2em] text-[#F4E5B1]/70 group-hover:text-[#D4AF37] transition-colors duration-300">
                  Explore Project →
                </p>
              </div>
